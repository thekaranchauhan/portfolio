...
const LinkedinCard = ({ name, designation, recommendation, image }: LinkedinProps) => {
  return (
      <motion.div
        style={{
      ...
      >
        ...
        <div className={`absolute right-0 top-14 mr-4 mb-10 md:mb-16 lg:mb-14 ml-24`}>
          <AnimatedTitle
            text={name}
            className={
          ...
          />
          <Link
          href={"https://www.linkedin.com/in/thekaranchauhan/details/recommendations/"}
          >
          <AnimatedBody
            text="Read more..."
            className={
